        ...
        .then(function () {
            ...
            return knex('february_musics').insert([
        ...
        },
                {
                    ...
                    theme: 'Black History Month',
                    source: 'bandcamp',
                    src_string: 'https://bandcamp.com/EmbeddedPlayer/album=2715910267/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/',
                    href_string: 'http://sampathegreat.bandcamp.com/album/the-return',
                    a_string: 'The Return by Sampa The Great',
                    rule: {
                        "monday": [16, 10, 12, 18],
                        "tuesday": [28, 3, 5, 9],
                        "wednesday": [2, 5, 7, 9],
        ...
        },
                {
                    ...
                    theme: 'Black History Month',
                    source: 'bandcamp',
                    src_string: 'https://bandcamp.com/EmbeddedPlayer/album=821188690/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/transparent=true/',
                    href_string: 'http://christianscott.bandcamp.com/album/ancestral-recall',
                    a_string: 'Ancestral Recall by Christian Scott aTunde Adjuah',
                    rule: {
                        "monday": [13, 7, 9, 11],
                        "tuesday": [15, 9, 11, 17],
                        "wednesday": [16, 10, 12, 18],
